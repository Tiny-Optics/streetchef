...
export const menuItems: MenuItem[] = [
  {
    ...
    options: [
      {
        name: 'Extras',
        choices: ['Bacon', 'Extra Cheese', 'Jalapenos']
      }
    ]
  },
  {
  ...
  },
  {
    ...
    description: 'Assorted nigiri and rolls including salmon, tuna, and california roll.',
    price: 24.99,
  ...
  },
  {
    id: '9',
    name: 'Beef Tacos',
    description: 'Three soft corn tortillas, seasoned ground beef, pico de gallo, cheese.',
    price: 11.99,
